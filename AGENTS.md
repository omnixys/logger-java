...
> Repository development instructions for **logger** (Shared Package).
> Stack: java-gradle. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys Logger Spring Integration Package.

- Repository path: `packages/java/logger` (relative to the Omnixys root)
...
src/main/java/com/omnixys/logger/{logging, autoconfigure, model, utils}
